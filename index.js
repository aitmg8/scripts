...
// Hardcode the Google Cloud Project ID and location
const projectId = 'voyageai-3hlrh';
const location = 'us-central1';

// Declare clients at the top level, but don't initialize them yet.
let storage;
let secretManager;
let visionClient;
let generativeModel;
...
/**
 * Initializes all Google Cloud clients if they haven't been already.
 * This "lazy loading" pattern is a best practice for Cloud Functions.
 */
...
exports.organizeFile = async (file, context) => {
    initializeClients(); // Ensure clients are ready
